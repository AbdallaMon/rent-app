...
const ReminderIcon = () => (
  ...
  >
    <path
      ...
      strokeWidth={2}
      d="M15 17h5l-5 5v-5zM4.5 5.653c0-.856.917-1.407 1.667-.986l11.54 6.348a1.125 1.125 0 010 1.971L6.167 19.334c-.75.421-1.667-.13-1.667-.986V5.653z"
    />
  </svg>
);
...
const getFailureReason = (reminder) => {
  const errorMessage =
    ...
    reminder.metadata?.error ||
    reminder.metadata?.errorMessage;
...
export default function RemindersPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
        ...
        <div className="flex justify-between items-start">
          <div className="flex-1">
            ...
            <p className="text-gray-600 mt-1">
              متابعة وإدارة جميع التذكيرات والإشعارات
            </p>
                ...
                <div className="flex items-center space-x-2 space-x-reverse">
                  ...
                  <span className="text-gray-600">
                    ...
                    <span className="font-semibold text-gray-900">
                      {formatEnglishNumber(summary.total || 0)}
                    </span>
                  </span>
                </div>
                <div className="flex items-center space-x-2 space-x-reverse">
                  ...
                  <span className="text-gray-600">
                    ...
                    <span className="font-semibold text-green-700">
                      {formatEnglishNumber(summary.byStatus?.delivered || 0)}
                    </span>
                  </span>
                </div>
                <div className="flex items-center space-x-2 space-x-reverse">
                  ...
                  <span className="text-gray-600">
                    ...
                    <span className="font-semibold text-yellow-700">
                      {formatEnglishNumber(summary.byStatus?.pending || 0)}
                    </span>
                  </span>
                </div>
                  ...
                  <div className="flex items-center space-x-2 space-x-reverse">
                    ...
                    <span className="text-gray-600">
                      ...
                      <span className="font-semibold text-red-700">
                        {formatEnglishNumber(summary.byStatus.failed)}
                      </span>
                    </span>
                  </div>
                )}
      ...
      {/* الإحصائيات الرئيسية - إحصائيات الدفعات والعقود */}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center p-4 bg-yellow-50 rounded-lg border border-yellow-200">
              <div className="text-2xl font-bold text-yellow-600">
                {formatEnglishNumber(
                  remindersData?.paymentStats?.totalPendingPayments || 0
                )}
              </div>
            ...
            <div className="text-center p-4 bg-green-50 rounded-lg border border-green-200">
              <div className="text-2xl font-bold text-green-600">
                {formatEnglishNumber(
                  remindersData?.paymentStats?.totalPaidPayments || 0
                )}
              </div>
            ...
            <div className="text-center p-4 bg-red-50 rounded-lg border border-red-200">
              <div className="text-2xl font-bold text-red-600">
                {formatEnglishNumber(
                  remindersData?.paymentStats?.overduePayments || 0
                )}
              </div>
            ...
            <div className="text-center p-4 bg-blue-50 rounded-lg border border-blue-200">
              <div className="text-2xl font-bold text-blue-600">
                {formatEnglishNumber(
                  remindersData?.paymentStats?.upcomingPayments || 0
                )}
              </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-blue-50 rounded-lg border border-blue-200">
              <div className="text-2xl font-bold text-blue-600">
                {formatEnglishNumber(
                  remindersData?.contractStats?.totalActiveContracts || 0
                )}
              </div>
            ...
            <div className="text-center p-4 bg-orange-50 rounded-lg border border-orange-200">
              <div className="text-2xl font-bold text-orange-600">
                {formatEnglishNumber(
                  remindersData?.contractStats?.expiringContracts || 0
                )}
              </div>
            ...
            <div className="text-center p-4 bg-purple-50 rounded-lg border border-purple-200">
              <div className="text-2xl font-bold text-purple-600">
                {formatEnglishNumber(
                  remindersData?.contractStats?.contractReminders || 0
                )}
              </div>
        ...
        <StatCard
          ...
          value={`${
            summary.todaySummary?.total > 0
              ? Math.round(
                  ((summary.todaySummary?.delivered || 0) /
                    summary.todaySummary.total) *
                    100
                )
              : 0
          }%`}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <DashboardSection title="توزيع أنواع التذكيرات" icon={PaymentIcon}>
          <div className="space-y-3">
            <ActivityCard
              title="تذكيرات الدفع"
              subtitle="أقساط ومدفوعات"
              value={formatEnglishNumber(
                summary.byType?.payment_reminder || summary.byType?.payment || 0
              )}
              color="green"
            />
            ...
            <ActivityCard
              ...
              value={formatEnglishNumber(
                summary.byType?.maintenance_reminder ||
            ...
            <ActivityCard
              ...
              value={formatEnglishNumber(
                summary.byType?.contract_expiry_reminder ||
        ...
        <DashboardSection title="حالة التسليم والمتابعة" icon={ActivityIcon}>
          <div className="space-y-3">
            <ActivityCard
      ...
      {/* البحث والتصفية - مع فلتر حالة الدفع الجديد */}
      <DashboardSection
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center p-4 bg-blue-50 rounded-lg border border-blue-200">
            <div className="text-xl font-bold text-blue-600">
              {formatEnglishNumber(
                remindersData?.scheduledSummary?.tomorrow || 0
              )}
            </div>
          ...
          <div className="text-center p-4 bg-purple-50 rounded-lg border border-purple-200">
            <div className="text-xl font-bold text-purple-600">
              {formatEnglishNumber(
                remindersData?.scheduledSummary?.thisWeek || 0
              )}
            </div>
          ...
          <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
            <div className="flex items-center">
              ...
              <span className="text-sm text-green-800 font-medium">
                النظام فعال! تم إنشاء{" "}
                {formatEnglishNumber(
                  (remindersData?.scheduledSummary?.tomorrow || 0) +
                    (remindersData?.scheduledSummary?.thisWeek || 0)
                )}{" "}
                تذكير مجدول بناءً على البيانات الفعلية
              </span>
            </div>
          </div>
        )}
      ...
      {/* الإجراءات السريعة */}
      <DashboardSection title="الإجراءات السريعة" className="mt-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-sm font-medium">
                      {formatArabicDate(selectedReminder.sentAt)}
                    </span>
                  </div>
                  <div>
                    <span className="text-sm text-gray-600 block mb-1">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    {selectedReminder.paymentStatus && (
                      <div>
                        ...
                        <PaymentStatusBadge
                          paymentStatus={selectedReminder.paymentStatus}
                        />
                      </div>
                    )}
                    {selectedReminder.dueDate && (
                      <div>
                        ...
                        <span className="text-sm font-medium">
                          {formatArabicDate(selectedReminder.dueDate)}
                        </span>
                      </div>
                    )}
                    ...
                    {selectedReminder.propertyName && (
                      <div className="col-span-2">
                        ...
                        <span className="text-sm font-medium">
                          {selectedReminder.propertyName}
                          {selectedReminder.unitNumber &&
                            ` - وحدة رقم ${selectedReminder.unitNumber}`}
                        </span>
                      </div>
                    )}
                  </div>

  ...
  const handleSavePaymentMethod = async () => {
    if (selectedInstallmentIndex !== null) {
      try {
        ...
        // Update local state
        updatedInstallments[selectedInstallmentIndex].paymentTypeMethod =
          editPaymentMethod;

        if (editPaymentMethod !== "CHEQUE") {
          updatedInstallments[selectedInstallmentIndex].chequeNumber = "";
          setValue(
            `installments[${selectedInstallmentIndex}].chequeNumber`,
            ""
          );
        } else {
          updatedInstallments[selectedInstallmentIndex].chequeNumber =
        ...
        setValue(
          `installments[${selectedInstallmentIndex}].paymentTypeMethod`,
          editPaymentMethod
        );
        ...
        >
          ...
          {editPaymentMethod === "CHEQUE" && (
            <TextField
              ...
              helperText={
                editPaymentMethod === "CHEQUE" && !editChequeNumber
                  ? "يرجى إدخال رقم الشيك"
                  : ""
              }
            />
          )}

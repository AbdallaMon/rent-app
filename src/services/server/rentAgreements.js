...
export async function createFeePayments(rentAgreement) {
    ...
    try {
        ...
        const managementCommission = property?.managementCommission || 0;
        const managementCommissionAmount = (rentAgreement.totalPrice * managementCommission) / 100;
        ...
        const feeInvoices = [
            ...
            // إضافة عمولة الإدارة كدفعة منفصلة
            {

-- SQL to ensure all required tables for the request page exist
-- This script ensures that all required tables for the request page are created
-- Execute this manually on your MySQL database if tables do not exist
